...
<body>
                ...
                <section id="section2">
                    ...
                    <aside>
                        <select  id="" style="width:21.5vw;height:3vh;border-radius:10px;text-align: center;" name="utility">
                            ...
                            <option value="Home Maintainance">Home Maintenance</option>
    ...
    <div id="menu" onmouseover="showMenu()" onmouseout="hideMenu()">
        <table border="2px" cellspacing="0px" style="margin-top: 5vh;">
            <tr class=".btn">
                <td onclick="location.href='home.jsp'">home</td>
            </tr>
            <tr class=".btn">
                <td onclick="location.href='login.jsp'">login</td>
            </tr><br>
            <tr class=".btn">
                <td onclick="location.href='signup.jsp'">sign up</td>
            </tr>
        </table>
    </div>
    </form>
